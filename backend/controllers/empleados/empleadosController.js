...
const crearEmpleado = async (req, res) => {
    try {
        const { 
            ...
            status_laboral, 
            fecha_reingreso, nivel_academico_id
        } = req.body;
        ...
        const generoDB = genero === '' ? null : genero; 
    ...
    try {
        ...
        const query = `
            UPDATE empleados SET
                ...
                empresa_id = $10, area_id = $11, puesto_id = $12, departamento_rh_id = $13, status_trabajador_id = $14,
                status_laboral = $15,
                fecha_reingreso = $16, 
                foto_emp = COALESCE($17, foto_emp),
                nivel_academico_id = $18,
                updated_at = NOW()
            WHERE id = $19
            RETURNING *;
        `;
        ...
        const values = [
            num_empl, empleado, fechaIngresoDB, rfc, nss, curp, 
            generoDB, fecha_nacimiento || null, aniosCalculados, 
            empresa_id || null, area_id || null, puesto_id || null, departamento_rh_id || null, status_trabajador_id || null,
            status_laboral || 'Activo', 
            fechaReingresoDB, foto_emp, nivel_academico_id || null,
            id
