  ...
  useEffect(() => {
    ...
    const unsubscribe = onAuthStateChanged(auth, async (user) => {
      ...
      try {
        ...
        // Extraemos solo los 'codigos' de la lista de objetos
        // ===============================================
        const codigosDeFunciones = res.funciones ? res.funciones.map(f => f.codigo) : [];
        setFuncionesPermitidas(codigosDeFunciones);
        // ===============================================
