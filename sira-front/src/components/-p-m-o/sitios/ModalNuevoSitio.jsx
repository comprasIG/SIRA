...
// Ajuste: Agregamos .js para asegurar la resolución correcta del archivo
...
export default function ModalNuevoSitio({ isOpen, onClose, onSave, sitioEditar = null }) {
  ...
  useEffect(() => {
    if (isOpen) {
      const fetchClientes = async () => {
        ...
        try {
          // Intentamos cargar de la ruta dashboard, si falla, intentamos la ruta general de clientes si existe
          ...
          // Fallback silencioso o manejo de error
        } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Si es edición, podríamos necesitar incluir el ID (depende de tu backend)
      if (sitioEditar) {
