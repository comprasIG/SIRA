...
import AssignmentIndIcon from '@mui/icons-material/AssignmentInd';// <-- Asegúrate de que este esté (para Unidades)
...
const iconMap = {
  ...
  AssignmentIndIcon: <AssignmentIndIcon sx={{fontSize:20}} />// <-- Asegúrate de que este esté (para Unidades)
};
